  ...
  function DataSet(props, context) {
    ...
    _this.handleResolve = function (value, params) {
      ...
      if (_this.props.getResolver) {
        var resolver = _this.props.getResolver(value, params || _this.props.params);
    ...
    if (props.getResolver) {
      _this._resolver = props.getResolver(props.defaultValue, props.params);
    }
    /**
     * prop = {
  ...
  _createClass(DataSet, [{
    ...
    value: function render() {
      ...
      if (Component) {
        ...
        return React.cloneElement(React.Children.only(children), _extends({
          ref: function ref(instance) {
