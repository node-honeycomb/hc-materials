  ...
  _createClass(NavLink, [{
    ...
    value: function render() {
      ...
      var menu = React.createElement(Menu, {
        ...
        }, propsByState), React.createElement("a", null, item.render ? item.render() : item.text || item.name));
      }));
      return React.createElement("div", {
        ...
        }, item.render ? item.render() : item.text || item.name) : React.createElement("span", null, item.render ? item.render() : item.text || item.name));
      }), menus.length ? this.props.menuLabel ? React.createElement(Dropdown.Button, {
        overlay: menu
      }, this.props.menuLabel) : React.createElement(Dropdown, {
        overlay: menu
      }, React.createElement("a", {
        className: "ant-dropdown-link ant-btn-link"
      }, this.getLocale().more, React.createElement(Icon, {
        type: "down"
      }))) : null);
    }
  }]);
...
NavLink = __decorate([localeContext('NavLink', {
  more: '更多'
})], NavLink);
export { NavLink };