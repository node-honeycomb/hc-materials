...
import { CopyLogger } from './copyLogger'; // 默认8秒
      ...
      if (opt.trace) {
        ...
        if (opt.content.then) {
          opt.content.then(function (res) {
            ...
            if (rid) {
              opt.content = React.createElement("div", null, React.createElement("span", null, res.message), React.createElement(CopyLogger, {
                rid: rid,
                message: 'rid: ' + rid
              }));
            } else {
          ...
          if (Object(opt.content) === opt.content) {
            ...
            if (rid) {
              opt.content = React.createElement("div", null, React.createElement("span", null, content), React.createElement(CopyLogger, {
                rid: rid,
                message: 'rid: ' + rid
              }));
            } else {
