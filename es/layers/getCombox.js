...
export function getCombox(_ref, findComponent) {
  ...
  function (_React$PureComponent) {
    ...
    function Combox(tprops, context) {
      ...
      var _getProps = converter.parse(getProps);
  ...
  if (hoc) {
    ...
    function (_React$PureComponent2) {
      ...
      _createClass(HocCombox, [{
        key: "render",
        value: function render() {
          var children = React.createElement(Com, null, React.createElement(HocCombox.ChildComponent, _extends({}, childProps, this.props))); // #! 包裹
