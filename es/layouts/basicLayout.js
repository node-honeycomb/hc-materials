...
import { getComponent as _getComponent } from './getComponent';
...
function (_React$PureComponent) {
  ...
  _createClass(BasicLayout, [{
    ...
    value: function getComponent(name) {
      return this.props.components[name] || _getComponent.emptyComponent;
    }
  }, {
    key: "hasComponent",
    value: function hasComponent(name) {
      return this.props.components[name] && this.props.components[name] !== _getComponent.emptyComponent;
    }
  }]);
...
BasicLayout.getLayoutProps = function (option, viewContent) {
  ...
  loop(option.components, function (item) {
    ...
    if (Com) {
      ...
      layoutProps.components[item.key] = layoutProps.components[item.key] || _getComponent(item.props, item.getProps, item.contextTypes)(Com);
