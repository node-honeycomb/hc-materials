...
function () {
  function Modaler(context) {
    ...
    ['info', 'success', 'error', 'warning', 'confirm'].forEach(function (action) {
      _this[action] = function (dialogProps) {
        ...
        var closeModal = Modal[action](dialogProps);
  ...
  _createClass(Modaler, [{
    ...
    value: function open(_a) {
      ...
      function (_React$PureComponent) {
        ...
        function Dialog(props) {
          ...
          _this2.state = {
            ...
            onOk: function onOk() {
              return trigger(dialogProps.onOk, _this2.setState.bind(_assertThisInitialized(_this2)));
            },
            onCancel: function onCancel() {
              return trigger(dialogProps.onCancel, _this2.setState.bind(_assertThisInitialized(_this2)));
            },
        ...
        _createClass(Dialog, [{
          ...
          value: function render() {
            return React.createElement(Modal, _extends({}, dialogProps, this.state), content);
          }
        }]);
      ...
      Dialog.childContextTypes = Modaler.contextTypes;
      ReactDOM.render(React.createElement(Dialog, null), this.wrapperDiv);
