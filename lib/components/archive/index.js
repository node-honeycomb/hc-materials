...
function (_React$PureComponent) {
  ...
  _createClass(IArchive, [{
    ...
    value: function render() {
      ...
      }, _react["default"].createElement(_antd.Row, null, this.getFields(), this.props.limit && this.props.limit < this.props.options.length ? _react["default"].createElement("a", {
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.dataSource !== prevState.dataSource) {
        return {
          dataSource: nextProps.dataSource || IArchive_1.defaultProps.dataSource
        };
      } else {
        return null;
      }
...
IArchive = IArchive_1 = __decorate([(0, _localeContext.localeContext)('Archive', {
  illegal: '表单校验失败'
  ...
  _createClass(ArchiveGroup, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        }, _react["default"].createElement("h5", null, item.title || name), _react["default"].createElement(_antd.Divider, null), _react["default"].createElement(Archive, _extends({}, item.attrs, _this3.props, {
          options: item.items,
