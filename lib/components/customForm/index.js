...
function (_React$PureComponent) {
  ...
  _createClass(CustomFormBase, [{
      ...
      return new Promise(function (resolve, reject) {
        _this3.props.form.validateFields(function (err, body) {
          if (err) {
            ...
            _message["default"].error(_this3.getLocale('illegal'));
          } else {
    ...
    value: function renderInput(option, key, _onChange) {
      ...
      if (option.children) {
        if (option.type === 'array') {
          ...
          return option.embed ? _react["default"].createElement(_form["default"].Item, _extends({
            key: key
      ...
      if (option.renderInput) {
        return option.renderInput(option, function (node, dpros) {
          return _react["default"].createElement(_form["default"].Item, _extends({
            key: key
    ...
    value: function render() {
      ...
      var buttons = _buttons ? _react["default"].createElement(_form["default"].Item, {
        wrapperCol: {
      ...
      var formElm = _react["default"].createElement(_form["default"], {
...
CustomFormBase = __decorate([(0, _localeContext.localeContext)('CustomForm'), __metadata("design:paramtypes", [Object])], CustomFormBase);

var CustomForm = _form["default"].create({
  withRef: true
})(CustomFormBase);
...
CustomForm.getFieldInput = function getFieldInput(option, props, stateProps, decorator) {
  ...
  if (option["enum"]) {
    input = _react["default"].createElement(_radio["default"].Group, _extends({}, props, stateProps), option["enum"].map(function (item) {
    ...
    if (option.format) {
      switch (option.format) {
        case 'DATE_TIME':
          ...
          input = _react["default"].createElement(_datePicker["default"], _extends({
            style: {
              maxWidth: 250
            },
            showTime: true,
        ...
        case 'TIME':
          ...
          decorator.initialValue = (0, _moment["default"])(decorator.defaultValue);
          input = _react["default"].createElement(_timePicker["default"], _extends({
            style: {
              maxWidth: 250
            },
            format: dataFormat
        ...
        case 'DATE_RANGE':
          input = _react["default"].createElement(_datePicker["default"].RangePicker, _extends({}, props, stateProps));
          break;
        ...
        case 'FILE':
          ...
          if (option.dragger) {
            input = _react["default"].createElement(_upload["default"].Dragger, _extends({}, props, stateProps, {
            ...
            input = _react["default"].createElement(_upload["default"], _extends({}, props, stateProps, {
              action: option.action,
              listType: option.format === 'FILE' ? 'text' : 'picture'
        ...
        case 'SELECT':
          ...
          if (option.mode === 'radio') {
            input = _react["default"].createElement(_radio["default"].Group, _extends({}, props, stateProps), options.map(function (item) {
              return _react["default"].createElement(_radio["default"], {
                key: item.value,
                value: item.value,
            ...
            input = _react["default"].createElement(_checkbox["default"].Group, _extends({}, props, stateProps, {
              options: options
            }));
          } else {
            input = _react["default"].createElement(_select["default"], _extends({
              mode: option.mode
        ...
        case 'Function':
        case 'JSON':
          input = _react["default"].createElement(_input["default"].TextArea, _extends({
            autosize: {
              minRows: 4,
              maxRows: 10
            }
        ...
        default:
          input = _react["default"].createElement(_input["default"], _extends({}, props, stateProps));
      }
    } else {
      ...
      switch (type) {
        ...
        case 'integer':
          ...
          input = _react["default"].createElement(_inputNumber["default"], _extends({
            style: {
              maxWidth: 250
            },
        ...
        case 'boolean':
          ...
          input = _react["default"].createElement(_switch["default"], _extends({
