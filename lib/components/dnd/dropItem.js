...
function (_React$PureComponent) {
  ...
  _createClass(DropItem, [{
    ...
    value: function render() {
      ...
      return this.props.connectDropTarget(_react["default"].createElement("div", _extends({
        className: className,
...
DropItem.propTypes = {
  ...
  types: _propTypes["default"].array.isRequired,
...
exports.DropItem = DropItem = __decorate([(0, _reactDnd.DropTarget)(function (props) {
  return props.types;
}, {
