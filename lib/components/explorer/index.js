...
function (_React$PureComponent) {
  ...
  _createClass(Explorer, [{
    ...
    value: function getIcon(item) {
      var icon = item.icon ? _react["default"].createElement(_antd.Icon, {
        type: item.icon
      }) : null;

      if (this.props.leafIcon) {
        return icon || (item.children ? null : _react["default"].createElement(_antd.Icon, {
      ...
      var nodes = dataSource.map(function (item) {
        ...
        if (actions && (_this4.props.byLeaf && !item.children || !_this4.props.byLeaf)) {
          btns = _react["default"].createElement("span", {
            ...
            }, btnItem.icon ? _react["default"].createElement(_antd.Icon, {
              type: btnItem.icon
            }) : btnItem.text);
          }));
        }
        ...
        if (item.children && item.children.length) {
          return _react["default"].createElement(_antd.Tree.TreeNode, {
            key: item.id,
            title: title,
    ...
    value: function renderSearch(dataSource) {
      ...
      }, _react["default"].createElement(_antd.Input.Search, searchProps));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, dataSource.length ? _react["default"].createElement(_antd.Tree, treeProps, this.loopTreeNode(dataSource, searchValue)) : _react["default"].createElement(_antd.Spin, {
