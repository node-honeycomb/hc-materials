...
function (_React$PureComponent) {
  ...
  _createClass(NavLink, [{
    ...
    value: function handleClick(e) {
      ...
      if (action) {
        var ret = action(e, this.props.data, cancelCallback);
    ...
    value: function render() {
      ...
      var menu = _react["default"].createElement(_antd.Menu, {
        ...
        var propsByState = item.getProps ? item.getProps(item, data) : {};
        return _react["default"].createElement(_antd.Menu.Item, _extends({
          key: item.key || index,
          disabled: item.disabled,
          loading: item.loading
        }, propsByState), _react["default"].createElement("a", null, item.render ? item.render() : item.text || item.name));
      }));
      ...
      return _react["default"].createElement("div", {
        ...
        }, item.render ? item.render() : item.text || item.name) : _react["default"].createElement("span", null, item.render ? item.render() : item.text || item.name));
      }), menus.length ? this.props.menuLabel ? _react["default"].createElement(_antd.Dropdown.Button, {
        overlay: menu
      }, this.props.menuLabel) : _react["default"].createElement(_antd.Dropdown, {
        overlay: menu
      }, _react["default"].createElement("a", {
        className: "ant-dropdown-link ant-btn-link"
      }, this.getLocale().more, _react["default"].createElement(_antd.Icon, {
        type: "down"
      }))) : null);
    }
  }]);
...
exports.NavLink = NavLink = __decorate([(0, _localeContext.localeContext)('NavLink', {
  more: '更多'
})], NavLink);