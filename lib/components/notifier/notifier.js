...
var seniorNotification = _extends({}, _antd.notification);

['success', 'info', 'warning', 'error', 'warn'].forEach(function (type) {
  seniorNotification[type] = function (args) {
    return _antd.notification[type](_extends({}, args, {
      type: type,
      duration: null
    }));
  };
  ...
  _createClass(Notifier, [{
    ...
    value: function notify(opt) {
      ...
      if (opt.trace) {
        ...
        if (strategy[opt.level] === _antd.notification) {
