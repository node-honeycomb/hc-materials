  ...
  function Sider(props) {
    ...
    _this.handleCollapse = function (collapsed) {
      ...
      if (_this.props.affixProps) {
        ...
        var dom = _reactDom["default"].findDOMNode(_this._affixRef.current);
    ...
    _this._affixRef = _react["default"].createRef();
  ...
  _createClass(Sider, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(Conn, connProps, brand ? _react["default"].createElement("div", {
        ...
        className: "hc-sider-menu-text"
      }, brand.title))) : null, _react["default"].createElement(Fragment, _extends({}, this.props.affixProps, {
        ref: this._affixRef
      }), prefix, _react["default"].createElement(_antd.Menu, _extends({
...
Sider.defaultProps = {
  ...
  getResolvePath: function getResolvePath(item) {
    return _path["default"].normalize('/' + item.path);
  },
  brand: {
