    ...
    value: function render() {
      ...
      var links = [{
        ...
        action: function action() {
          _this.app.replace(_this.context.app.route(_bootstrap.bootstrap.getPrefix(_this.context.app)).resolvePath);
        }
      }];
...
ExceptionScene = __decorate([(0, _localeContext.localeContext)('Exception', {
  backToHome: '返回首页',
  403: '抱歉，你无权访问该页面',
  404: '抱歉，你访问的页面不存在',
  500: '抱歉，服务器出错了'
