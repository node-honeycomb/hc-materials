...
function getCombox(_ref, findComponent) {
  ...
  function (_React$PureComponent) {
    ...
    function Combox(tprops, context) {
      ...
      var propsMap = _getProps ? _getProps.call(_assertThisInitialized(_this), tprops, context) : props || {};
      _this.state = {
        ...
        value: function render() {
          ...
          var children = _react["default"].createElement(Com, {
            ref: function ref(inst) {
              return _this3._childRef = inst;
            }
          }, _react["default"].createElement(HocCombox.ChildComponent, _extends({}, childProps, this.props))); // #! 包裹
