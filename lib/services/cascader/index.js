  ...
  function Cascader() {
    ...
    this.getFieldDecorator = function (name, _ref) {
      var rely = _ref.rely,
          ...
          argIndex = _ref$argIndex === void 0 ? 2 : _ref$argIndex,
      ...
      return function (Field) {
        ...
        */
        ...
        var getProps = function getProps(props, context, setState, istate) {
          var newProps = _getProps ? _getProps(props, context, setState, istate) : {}; // 拿到ref实例
          ...
          if (cascadeEvents) {
            // 遍历级联事件
            (0, _forEach["default"])(cascadeEvents, function (cascades, eventName) {
